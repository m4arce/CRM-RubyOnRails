...
class ProspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post prospects_url, params: { prospect: { apellido: @prospect.apellido, email: @prospect.email, nombre: @prospect.nombre, status_id: @prospect.status_id, telefono: @prospect.telefono, user_id: @prospect.user_id } }
    end
  ...
  test "should update prospect" do
    patch prospect_url(@prospect), params: { prospect: { apellido: @prospect.apellido, email: @prospect.email, nombre: @prospect.nombre, status_id: @prospect.status_id, telefono: @prospect.telefono, user_id: @prospect.user_id } }
